...
- `v2/preview/` не референс. Экраны: [docs/UX-PROPOSAL.md](docs/UX-PROPOSAL.md) (**D+**, правки HUMAN §9). В UI **«Калькулятор»**, URL **`/calculator`**.
...
## Не открывать, пока спринт не про это

- [docs/UX.md](docs/UX.md) — закрытый бриф аналитика.
- [docs/RECIPE.md](docs/RECIPE.md) — волны только после «стартуй волну 1»; поля дельт/отрубов читать можно.
...
- Волны рецептов без «стартуй волну 1». `editorial_tested` от агента. High-risk без «Осторожно».
