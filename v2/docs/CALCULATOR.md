...
Щепотка и чайная ложка специй не докупаются. «По вкусу» у ядра (стейк) — докупается. `PANTRY_ASSUMED` всегда в шкафу. `PANTRY_COMMON` не блокирует («желательно паприка»). Составные ETL-id вроде `water_or_stock` — не товары. Редакционный блок **Из шкафа** на карточке рецепта — [RECIPE.md](RECIPE.md); лимон/уксус в ложке не ядро закупки набора.
...
`/calculator?protein_base=beef` — шаурма с чипом «С говядиной» в выдаче, ссылка с `variant=beef`.  
