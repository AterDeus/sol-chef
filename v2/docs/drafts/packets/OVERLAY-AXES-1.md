...
Источник: `export_draft --slug`. Базу не ломать, кроме шашлыка (смена базы: архив WAVE-1).
...
Как архив `docs/archive/packets/WAVE-1.md` § оверлей. Сейчас база — духовка. **Сделать базу `grill` + `equipment=grill`**, духовку и сковороду — вариантами. `id` не менять. Title можно «Шашлык из свинины», если уже так.
