...
Ценность — **component meal prep**: одна подготовка даёт разные будничные блюда. Не несколько одинаковых кастрюль и не «ещё 14 рецептов».
...
- крупы остужать пластом, в холод ≤90 мин ([SAFETY.md](../SAFETY.md));
- 7 дней: часть в морозилке, не всё в холодильнике; жидкости размораживать 24–36 ч;
- сырое и полуготовое раздельно от зелени; разморозка один раз;
