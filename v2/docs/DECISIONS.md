...
## DEC-028 — Основа чипа в фильтре

Status: accepted · HUMAN 9.1 уточнение 2026-09-20

Одно семейство, один slug. Если addon с дельтой меняет основу — `protein_base_override`. Фильтр `protein_base=` матчит базу, `protein_bases_extra` и override (как способ матчит `cook_method_override`). Книга может показать карточку во втором белковом разделе с пометкой чипа. Завтрак / десерт / гарнир не утекают. Не угадывать основу по любому канону состава.
