...
Это **не канон** и не волна. Канон: [`v2/docs/RECIPE.md`](v2/docs/RECIPE.md), [`VOCAB.md`](v2/docs/VOCAB.md), [`SAFETY.md`](v2/docs/SAFETY.md), [`DATA-MODEL.md`](v2/docs/DATA-MODEL.md), калькулятор: [`CALCULATOR.md`](v2/docs/CALCULATOR.md). Этот файл — пакет для анализа: какой JSON ждать от автора.
...
| Промпт автора | [`docs/ADD_RECIPE.md`](docs/ADD_RECIPE.md) + старые `RECIPE_AI_*` | [`v2/docs/RECIPE.md`](v2/docs/RECIPE.md) |
...
Калькулятор ([CALCULATOR.md](v2/docs/CALCULATOR.md)) собирает **CookingSolution**: что приготовить из ситуации человека, как адаптировать, при каких условиях, какой вариант лучше. Цепочка другая:
...
[`RECIPE-INVENTORY.md`](v2/docs/RECIPE-INVENTORY.md) в будущем — не только ниши VOCAB, а **матрица ситуаций**: быстро; из базовой корзины; одна посуда; без молочного; конкретный белок; конкретная крупа; batch. Волна закрывает дыры матрицы, не плодит четвёртую целую курицу.
